...
function [fwd_mesh,pj_error] = reconstruct_stnd_cw_Lp(fwd_mesh,...
						recon_basis,...
						data_fn,...
						iteration,...
						lambda,...
...
% Calvin B. Shaw and Phaneendra K. Yalavarthy, “Iteratively Reweighted L1 minimization provides optimal performance for non-convex Lp minimization in diffuse optical tomographic imaging," Journal of Biomedical Optics, (2013) (Under Review).
...
for it = 1 : iteration
 ...
 %%%%% Compressive Sensing Should strat here %%%%%%%%%%%%
  N = recon_mesh.mua;
   ...
   [r c]=size(J);
     ...
     foo = opt_lambda(J,data_diff,recon_mesh.mua); %Function to optimally determine the solution using Lp-regularization
     %The above function uses IRLS, IRL1 and ITM for comparisions
